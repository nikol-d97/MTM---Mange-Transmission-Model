...
<experiments>
  <experiment name="experiment 1" repetitions="50" runMetricsEveryStep="true">
    ...
    <metric>sum [open-area-infected] of turtles</metric>
    <metric>sum [road-infected] of turtles</metric>
    <metric>sum [forest-edge-infected] of turtles</metric>
    <enumeratedValueSet variable="num-foxes-left-patch">
      <value value="8"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="num-foxes-right-patch">
      <value value="8"/>
    </enumeratedValueSet>
